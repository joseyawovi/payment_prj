    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ref_code', shortuuid.django_fields.ShortUUIDField(alphabet='abcdefgh1234567890', length=10, max_length=7, prefix='DEX', unique=True)),
                ('account_status', models.CharField(choices=[('in-active', 'In-ctive'), ('active', 'Active')], default='in-active', max_length=100)),
